...
import weather
import currency
# import air_raid  # Временно отключаем модуль air_raid
from keyboards import create_main_menu, create_weather_preference_keyboard, create_weather_menu, create_exchange_menu # Удалили create_alert_menu
...
def handle_any_message(message):
    ...
    if user_id in user_states:
        ...
        # elif user_id in user_states and user_states[user_id] == "waiting_for_alert_region": # Закомментировано
        #     handle_alert_region_input(message) # Закомментировано
    elif message.text == "☀️ Погода":
        handle_weather_button(message)
    elif message.text == "💰 Курсы валют":
        handle_exchange_button(message)
    # elif message.text == "🚨 Воздушная тревога": # Закомментировано
    #     handle_alert_button(message) # Закомментировано
    ...
    # elif message.text == "📄 Список областей": # Закомментировано
    #     alerts_list = air_raid.get_alerts_list_xml() # Закомментировано
    #     bot.reply_to(message, alerts_list, reply_markup=create_alert_menu()) # Закомментировано
    # elif message.text == "🗺️ Показать карту": # Закомментировано
    #     map_image = air_raid.get_alerts_map_image() # Закомментировано
    #     if map_image: # Закомментировано
    #         bot.send_photo(message.chat.id, map_image, reply_markup=create_alert_menu()) # Закомментировано
    #     else: # Закомментировано
    #         bot.reply_to(message, "Не удалось загрузить карту тревог.", reply_markup=create_alert_menu()) # Закомментировано
    # elif message.text == "📍 Узнать по региону": # Закомментировано
    #     user_id = message.from_user.id # Закомментировано
    #     bot.reply_to(message, "Введите название региона:", reply_markup=create_alert_menu()) # Закомментировано
    #     user_states[user_id] = "waiting_for_alert_region" # Закомментировано
